...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "todoForm--backDrop svelte-1vpeeca");
    			add_location(div, file$3, 4, 4, 69);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(div, "click", self(/*click_handler*/ ctx[3]), false, false, false, false);
    				mounted = true;
    			}
    		},
    ...
    /* src\TodoForm.svelte generated by Svelte v3.59.2 */
    const file$1 = "src\\TodoForm.svelte";
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", prevent_default(/*formSubmit*/ ctx[2]), false, true, false, false)
    				];
    ...
    // (19:0) <Modal {showModal} on:click={toggleModal}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(19:0) <Modal {showModal} on:click={toggleModal}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 23, 8, 561);
    			add_location(button, file, 24, 8, 613);
    			attr_dev(div, "class", "todo__wrapper svelte-1usjya1");
    			add_location(div, file, 22, 4, 525);
    			add_location(main, file, 21, 0, 514);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
